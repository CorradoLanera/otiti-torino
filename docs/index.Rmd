...
# Deep learning algorithms for<br>automatic classification of electronic medical records<br>starting from free text
...
2019/10/22 - University of Torino
]
...
Overview: otitis and text classification

<!-- Task: multi-class classification -->

Programming paradigms: classical and machine learning

Classical: search string and regular expression

Shallow machine learning: document-text matrix

Deep-learning: basics

Embeddings: dense representation of text
...
Our approach: architectures explored
